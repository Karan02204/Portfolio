...
const isCanvasRef=useRef(null);if(isCanvasRef.current===null){isCanvasRef.current=false;}const isCanvas=isCanvasRef.current;// Hardcode parallax values: start = 0% (bottom), end = 100% (top)
