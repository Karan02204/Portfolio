...
export function FocusRail({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[1300px] w-full flex-col overflow-hidden bg-neutral-950 text-white outline-none select-none overflow-x-hidden",
        className
      )}
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
        <motion.div
          className="relative mx-auto flex h-[560px] w-full max-w-6xl items-start justify-center perspective-[1200px] cursor-grab active:cursor-grabbing"
          drag="x"
          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                key={item.id}
                className={cn(
                  "absolute aspect-[16/9] w-[360px] md:w-[860px] rounded-2xl border-t border-white/20 bg-neutral-900 shadow-2xl transition-shadow duration-300",
